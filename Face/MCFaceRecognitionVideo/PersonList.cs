...
namespace MCFaceRecognitionVideo
{
	public class PersonList : XtraForm
	{
		...
		private void InitializeComponent()
		{
            ...
            ComponentResourceManager resources = new ComponentResourceManager(typeof(PersonList));

            //ResourceManager rm = new ResourceManager(typeof(PersonList));
            ...
            //this.imageList1.ImageStream = (ImageListStreamer)rm.GetObject("imageList1.ImageStream");
			...
			this.btn_export.Image = (Image)resources.GetObject("btn_export.Image");
			...
			this.btn_select.Image = (Image)resources.GetObject("btn_select.Image");
