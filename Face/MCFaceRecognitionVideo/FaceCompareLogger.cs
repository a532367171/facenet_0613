...
namespace MCFaceRecognitionVideo
{
	public class FaceCompareLogger : XtraForm
	{
		...
		{
			ComponentResourceManager resources = new ComponentResourceManager(typeof(FaceCompareLogger));
			...
			this.btn_extport.Image = (Image)resources.GetObject("btn_extport_Image");
			...
			this.btn_Search.Image = (Image)resources.GetObject("btn_Search_Image");
			...
			this.imageList1.ImageStream = (ImageListStreamer)resources.GetObject("ImageStream");
