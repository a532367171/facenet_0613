...
namespace MCFaceRecognitionVideo
{
	public class LoadingForm : SplashScreen
	{
		...
		{
            System.ComponentModel.ComponentResourceManager resources1 = null;

            resources1 = new System.ComponentModel.ComponentResourceManager(typeof(LoadingForm));

            //ResourceManager rm = new ResourceManager(typeof(LoadingForm));
            ...
            this.pictureEdit2.EditValue = (Image)resources1.GetObject("pictureEdit2_EditValue");
            //this.pictureEdit2.EditValue = (Image)rm.GetObject("pictureEdit2.EditValue");
            ...
            this.pictureEdit1.EditValue = (Image)resources1.GetObject("pictureEdit1_EditValue");
            //this.pictureEdit1.EditValue = (Image)rm.GetObject("pictureEdit1.EditValue");
