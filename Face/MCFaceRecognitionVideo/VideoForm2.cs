...
namespace MCFaceRecognitionVideo
{
	public class VideoForm2 : XtraForm
	{
		[CompilerGenerated]
		[Serializable]
		private sealed class VideoForm2_class_c
		{
			public static readonly VideoForm2.VideoForm2_class_c VideoForm2_class_c_9 = new VideoForm2.VideoForm2_class_c();
			public static Func<Person, long> VideoForm2_class_c_9__38_0;
			public static Func<Person, FaceTemplate> VideoForm2_class_c_9__38_1;
			public static Action VideoForm2_class_c_9__43_0;
			public static Action VideoForm2_class_c_9__44_0;
			public static Action VideoForm2_class_c_9__46_0;

            public static Func<CamerInfo, bool> VideoForm2_class_c_9__1;
            //public static Func<CamerInfo, bool> VideoForm2_class_c_9__1;


            internal long _GetTemplate_b__38_0(Person p)
			{
				return p.ID;
			}
			internal FaceTemplate _GetTemplate_b__38_1(Person person)
			{
			...
			internal void _toolStripButton2_Click_b__43_0()
			{
			...
			internal void _tsb_camerSet_Click_b__44_0()
			{
				new CamerSetForm().Show();
			}
			internal void _tsb_FaceCompareLog_Click_b__46_0()
			{
    ...
    private void OnCompareSuccessHander(List<ResultInfo> recognitions, string controlName)
		{
		//	//Func<CamerInfo, bool> VideoForm2_class_c_9__1;
  //          DEL3 dEL3 = delegate
  //           {
  //               try
  //               {
  ...
  //                   lock (obj)
  //                   {
  //                       VideoForm2.VideoForm2_class_c__DisplayClass31_2 VideoForm2_class_c__DisplayClass31_2 = new VideoForm2.VideoForm2_class_c__DisplayClass31_2();
  //                       VideoForm2.VideoForm2_class_c__DisplayClass31_2 arg_46_0 = VideoForm2_class_c__DisplayClass31_2;
  //                       IEnumerable<CamerInfo> arg_41_0 = this._camerInfos;
  //                       Func<CamerInfo, bool> arg_41_1;
  //                       if ((arg_41_1 = VideoForm2_class_c.VideoForm2_class_c_9__1) == null)
  //                       {
  //                           arg_41_1 = (VideoForm2_class_c.VideoForm2_class_c_9__1 = ((CamerInfo p) => p.ID == (long)int.Parse(controlName)));
  //                       }
  //                       arg_46_0.camerInfo = arg_41_0.FirstOrDefault(arg_41_1);
  //                       if (VideoForm2_class_c__DisplayClass31_2.camerInfo != null)
  //                       {
  //                           string channel = VideoForm2_class_c__DisplayClass31_2.camerInfo.Channel;
  ...
  //                           {
  //                               SaveFaceCompareThred.AddFaceCompare(recognition, channel, faceImage, VideoForm2_class_c__DisplayClass31_2.camerInfo.CamerAddress);
  //                           })).Start();
  //                       }
  //                   }
  //               }
  ...
  //          this.flowLayoutPanel2.BeginInvoke(dEL3);
		}
        ...
        private void OnShowFaceDeteiveImage(byte[] imageData, FaceModel faceModels, string controlName)
		{
            ...
            DEL4 dEL4 = delegate
            {
                try
                {
                    ...
                    if ((arg_2A_1 = VideoForm2_class_c.VideoForm2_class_c_9__1) == null)
                    {
                        arg_2A_1 = (VideoForm2_class_c.VideoForm2_class_c_9__1 = ((CamerInfo p) => p.ID == (long)int.Parse(controlName)));
                    }
            ...
            this.faceDetectiveControl1.BeginInvoke(dEL4);
		}
		...
		private List<FaceTemplate> GetTemplate()
		{
			...
			if ((arg_3D_1 = VideoForm2.VideoForm2_class_c.VideoForm2_class_c_9__38_0) == null)
			{
				arg_3D_1 = (VideoForm2.VideoForm2_class_c.VideoForm2_class_c_9__38_0 = new Func<Person, long>(VideoForm2.VideoForm2_class_c.VideoForm2_class_c_9._GetTemplate_b__38_0));
			}
			...
			if ((arg_82_1 = VideoForm2.VideoForm2_class_c.VideoForm2_class_c_9__38_1) == null)
			{
				arg_82_1 = (VideoForm2.VideoForm2_class_c.VideoForm2_class_c_9__38_1 = new Func<Person, FaceTemplate>(VideoForm2.VideoForm2_class_c.VideoForm2_class_c_9._GetTemplate_b__38_1));
			}
		...
		{
			Action arg_20_1;
			if ((arg_20_1 = VideoForm2.VideoForm2_class_c.VideoForm2_class_c_9__43_0) == null)
			{
				arg_20_1 = (VideoForm2.VideoForm2_class_c.VideoForm2_class_c_9__43_0 = new Action(VideoForm2.VideoForm2_class_c.VideoForm2_class_c_9._toolStripButton2_Click_b__43_0));
			}
		...
		{
			Action arg_20_1;
			if ((arg_20_1 = VideoForm2.VideoForm2_class_c.VideoForm2_class_c_9__44_0) == null)
			{
				arg_20_1 = (VideoForm2.VideoForm2_class_c.VideoForm2_class_c_9__44_0 = new Action(VideoForm2.VideoForm2_class_c.VideoForm2_class_c_9._tsb_camerSet_Click_b__44_0));
			}
			base.BeginInvoke(arg_20_1);
		}
		...
		{
			Action arg_20_1;
			if ((arg_20_1 = VideoForm2.VideoForm2_class_c.VideoForm2_class_c_9__46_0) == null)
			{
				arg_20_1 = (VideoForm2.VideoForm2_class_c.VideoForm2_class_c_9__46_0 = new Action(VideoForm2.VideoForm2_class_c.VideoForm2_class_c_9._tsb_FaceCompareLog_Click_b__46_0));
			}
			base.BeginInvoke(arg_20_1);
		}
        ...
        private void timer1_Tick(object sender, EventArgs e)
		{
			using (List<FaceTemplate>.Enumerator enumerator = (this.GetTemplate() ?? new List<FaceTemplate>()).GetEnumerator())
			{
				while (enumerator.MoveNext())
				{
                    ...
                    this.faceDetectiveControl1.BeginInvoke(dEL5);
				}
			}
		}
		...
		{
			ComponentResourceManager resources = new ComponentResourceManager(typeof(VideoForm2));
			...
			this.tsb_PersonList.Image = (Image)resources.GetObject("tsb_PersonList.Image");
			...
			this.tsb_Logger.Image = (Image)resources.GetObject("tsb_Logger.Image");
			...
			this.tsb_SystemSet.Image = (Image)resources.GetObject("tsb_SystemSet.Image");
