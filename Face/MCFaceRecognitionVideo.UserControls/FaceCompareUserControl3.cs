	...
	public class FaceCompareUserControl3 : UserControl
	{
		...
		public new void Load(ResultInfo _recognition, string Channel)
		{
			...
			if (person != null)
			{
				...
				this.labelComponent1.Text=_recognition.Score.ToString("p");
				this.arcScaleRangeBarComponent1.Value=new float?(_recognition.Score * 100f);
		...
		public void Clear()
		{
			...
			this.labelComponent1.Text="0.00%";
			this.lbl_time.Text = string.Empty;
			this.arcScaleRangeBarComponent1.Value=new float?(0f);
		}
		...
		private void InitializeComponent()
		{
			...
			this.gaugeControl1.BorderStyle=BorderStyles.NoBorder;
			this.gaugeControl1.Gauges.AddRange(new IGauge[]
			{
				this.circularGauge1
			});
			...
			this.circularGauge1.Bounds=new Rectangle(2, 3, 195, 184);
			this.circularGauge1.Labels.AddRange(new LabelComponent[]
			{
				this.labelComponent1,
				this.labelComponent2
			});
			this.circularGauge1.Name="circularGauge1";
			this.circularGauge1.RangeBars.AddRange(new ArcScaleRangeBarComponent[]
			{
				this.arcScaleRangeBarComponent1
			});
			this.circularGauge1.Scales.AddRange(new ArcScaleComponent[]
			{
				this.arcScaleComponent1
			});
			this.labelComponent1.AppearanceText.Font=(new Font("Segoe UI", 27.75f));
			this.labelComponent1.Name="circularGauge1_Label1";
			this.labelComponent1.Shader=new StyleShader("Colors[Style1:OrangeRed;Style2:OrangeRed]");
			this.labelComponent1.Size=new SizeF(140f, 60f);
			this.labelComponent1.Text="910";
			this.labelComponent1.UseColorScheme=false;
			this.labelComponent1.ZOrder=-1001;
			this.labelComponent2.AppearanceText.Font=(new Font("Tahoma", 15f));
			this.labelComponent2.AppearanceText.TextBrush=(new SolidBrushObject("Color:Black"));
			this.labelComponent2.Name="circularGauge1_Label2";
			this.labelComponent2.Position=new PointF2D(125f, 175f);
			this.labelComponent2.Shader=new StyleShader("Colors[Style1:White;Style2:White]");
			this.labelComponent2.Text="相似度";
			...
			this.arcScaleRangeBarComponent1.Shader=new StyleShader("Colors[Style1:OrangeRed;Style2:OrangeRed]");
			...
			this.arcScaleComponent1.AppearanceMajorTickmark.BorderBrush=(new SolidBrushObject("Color:White"));
			this.arcScaleComponent1.AppearanceMajorTickmark.ContentBrush=(new SolidBrushObject("Color:White"));
			this.arcScaleComponent1.AppearanceMinorTickmark.BorderBrush=(new SolidBrushObject("Color:White"));
			this.arcScaleComponent1.AppearanceMinorTickmark.ContentBrush=(new SolidBrushObject("Color:White"));
			this.arcScaleComponent1.AppearanceTickmarkText.Font=(new Font("Tahoma", 8.5f));
			this.arcScaleComponent1.AppearanceTickmarkText.TextBrush=(new SolidBrushObject("Color:#484E5A"));
			this.arcScaleComponent1.Center=(new PointF2D(125f, 125f));
			...
			//this.arcScaleComponent1.MajorTickmark.ShapeType = 67;
            this.arcScaleComponent1.MajorTickmark.ShapeType = TickmarkShapeType.Circular_Style16_1;

            this.arcScaleComponent1.MajorTickmark.TextOrientation= LabelOrientation.LeftToRight;
			this.arcScaleComponent1.MaxValue=(100f);
			this.arcScaleComponent1.MinorTickCount=(0);
			this.arcScaleComponent1.MinorTickmark.ShapeOffset=(-7f);
			//this.arcScaleComponent1.MinorTickmark.ShapeType=68;

            this.arcScaleComponent1.MinorTickmark.ShapeType = TickmarkShapeType.Circular_Style16_2;
